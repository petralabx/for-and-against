...
| Competitor | Segment overlap | Page |
|---|---|---|
| Salt & Stone | Body wash, deodorant, body care — primary reference brand | [salt-and-stone.md](salt-and-stone.md) |
...
**How to populate these pages:** competitor ASINs are the source ASINs of the Jungle Scout exports in `data/keywords/2026-07/`. Extract them, verify current prices on Amazon, fill the dupe map, and register them in `data/pricing/tracked-asins.json`.
